...
<div class="card card-custom gutter-b">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-checkable" id="kt_datatable">
                <a href="{{ route("colonias")}}">Volver a la lista de colonias</a>
            <h1>Confirmar eliminacion de colonia: </h1>
            <p>Estas seguro de eliminar la colonia: ?</p>
            <form method="POST" action="{{route("colonias.destroy", $colonia->id)}}">
            @csrf
            @method("delete")
            <a href="{{ route("colonias")}}"><button>Cancelar</button></a>
