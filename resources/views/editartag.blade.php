...
<div class="card card-custom gutter-b">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-checkable" id="kt_datatable">
            <form method="POST" action="{{route("tags.actualizar", $tags->id)}}">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="">Descripcion:</label>
                    <input type="text" class="form-control" name="descripcion" value="{{$tags->descripcion}}" onclick="$('.descripcion').slideUp();">
