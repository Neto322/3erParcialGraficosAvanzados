...
<div class="card card-custom gutter-b">
        ...
        <div class="card-body">
            <div class="d-flex align-items-center p-5">
                <div class="d-flex flex-column">
                    <a href="#" class="text-dark text-hover-primary font-weight-bold font-size-h3 mb-3">Nuevo Editor.</a>
                    <div class="text-dark-75">Agrega nuevas cuentas que administraran los OSC.</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-checkable" id="kt_datatable">
            <form method="POST" action="{{route("actualizar", $usuarios->id)}}">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="">Nombre:</label>
                    <input type="text" class="form-control" name="name" value="{{$usuarios->name}}" onclick="$('.nombre').slideUp();">
                    @error('name')
                      <div class="alert-danger nombre">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    <label for="">Correo:</label>
                    <input type="text" class="form-control" name="email" value="{{$usuarios->email}}" disabled>
                </div>
                <div class="form-group">
