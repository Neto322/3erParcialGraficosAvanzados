...
<div class="card card-custom gutter-b">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-checkable" id="kt_datatable">
            <form method="POST" action="{{route("colonias.actualizar", $colonias->id)}}">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label for="">Nombre:</label>
                    <input type="text" class="form-control" name="nombre" value="{{$colonias->nombre}}" onclick="$('.nombre').slideUp();">
